...
//each number button adds that number to a string in display, but then that string needs to be converted into a number before any operation runs
...
//#display.textContent or .innerHTML = 0
